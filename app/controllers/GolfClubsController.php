...
class GolfClubsController extends BaseController {
	...
	public function postCreate() {
		...
		if ($validator->passes()) {
			...
			$golfclub->sloperating = Input::get('sloperating');
			$golfclub->courserating = Input::get('courserating');
			$golfclub->drivingrange = Input::get('drivingrange', FALSE);
			$golfclub->caddie = Input::get('caddie', FALSE);
			$golfclub->chariot = Input::get('chariot', FALSE);
			$golfclub->chariotelectrique = Input::get('chariotelectrique', FALSE);
			$golfclub->voiturette = Input::get('voiturette', FALSE);
			$golfclub->locationclubs = Input::get('locationclubs', FALSE);
			$golfclub->lecon = Input::get('lecon', FALSE);
			$golfclub->chambre = Input::get('chambre', FALSE);
			$golfclub->piscine = Input::get('piscine', FALSE);
			$golfclub->spa = Input::get('spa',FALSE);
			$golfclub->tennis = Input::get('tennis', FALSE);
